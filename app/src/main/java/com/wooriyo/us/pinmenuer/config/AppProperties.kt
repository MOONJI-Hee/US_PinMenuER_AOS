package com.wooriyo.us.pinmenuer.config
...
class AppProperties {
    companion object {
        ...
        const val RT_ONE_LINE_BIG = 24     // 큰 글자 (넓이 두배) 한 줄 개수 - 공백, 하이픈, 소문자, 대문자 모두 동일)

        const val RT_PRODUCT_BIG = 20      // 큰 글자 기준, 상품명 칸에 들어갈 글자 개수
        const val RT_QTY_BIG = 3           // 큰 글자 기준, 수량 칸에 들어갈 글자 개수
        const val RT_AMT_BIG = 6           // 큰 글자 기준, 가격 칸에 들어갈 글자 개수 (vvAMTv) (000.00) (#00.00) (##0.00)

        const val RT_PRODUCT_SMALL = 43    // 작은 글자 기준, 상품명 칸에 들어갈 글자 개수
        const val RT_QTY_SMALL = 3         // 작은 글자 기준, 수량 칸에 들어갈 글자 개수
        const val RT_AMT_SMALL = 6         // 작은 글자 기준, 가격 칸에 들어갈 글자 개수 (vvAMTv) (000.00) (#00.00) (##0.00)

        var RT_ONE_LINE = RT_ONE_LINE_SMALL
